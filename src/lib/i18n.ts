...
const zhCN: Record<string, string> = {
  ...
  "app.remove": "移除",
  "app.settings": "设置",
  "app.cloud_section": "云服务器",
  "app.custom_section": "自定义服务器",
  "app.cloud_loading": "正在加载云服务器…",
  "app.cloud_empty": "暂无可用云服务器",
  "app.cloud_select_hint": "选择云服务器",
  "app.cloud_load_failed": "云服务器列表加载失败",
  "app.cloud_retry": "重试",
  "app.server_subtitle": "连接您的 Yao Engine 服务器",
  "app.register_helper": "部分服务器为邀请制，需要邀请码才能注册。可前往站点申请。",
  "app.register_link": "前往注册申请邀请码",
  "app.custom_full_hint": "填写完整服务器地址（含协议）",
...
const enUS: Record<string, string> = {
  ...
  "app.cloud_section": "Cloud Servers",
  "app.custom_section": "Custom Server",
  "app.cloud_loading": "Loading cloud servers…",
  "app.cloud_empty": "No cloud servers available",
  "app.cloud_select_hint": "Select a cloud server",
  "app.cloud_load_failed": "Failed to load cloud servers",
  "app.cloud_retry": "Retry",
  "app.server_subtitle": "Connect to your Yao Engine server",
  "app.register_helper": "Some servers are invite-only and need a code to register. You can apply on the site.",
  "app.register_link": "Register / apply for a code",
  "app.custom_full_hint": "Enter the full server URL (with protocol)",
